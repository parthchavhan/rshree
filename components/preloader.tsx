    ...
    return (
        ...
        >
            ...
            <div className="preloader-heading">
                ...
                >
                    <motion.span style={{ color: '#bea994' }}>R</motion.span>
                    <motion.span style={{ color: '#bea994' }}>s</motion.span>
                    <motion.span style={{ color: '#bea994' }}>h</motion.span>
                    <motion.span style={{ color: '#bea994' }}>r</motion.span>
                    <motion.span style={{ color: '#bea994' }}>e</motion.span>
                    <motion.span style={{ color: '#bea994' }}>e</motion.span>
